...
exports.OKXAIService = exports.OKX_AI_TOOLS = void 0;
exports.OKX_AI_TOOLS = [
    {
...
class OKXAIService {
    ...
    getStatus() {
        return {
            ...
            supportedToolsCount: exports.OKX_AI_TOOLS.length,
            tools: exports.OKX_AI_TOOLS.map(t => t.name),
            endpoint: '/api/integrations/okx/ai'
        };
    }
    getTools() {
        return exports.OKX_AI_TOOLS;
    }
    generateRequestId() {
        return `REQ-OKX-${Math.random().toString(36).substring(2, 8).toUpperCase()}`;
    }
    formatResponse(data, startTime, error) {
...
exports.OKXAIService = OKXAIService;
